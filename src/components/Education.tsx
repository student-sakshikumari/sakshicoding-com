  ...
  return (
    <Section id="education">
      ...
      <div className="relative max-w-3xl mx-auto">
        ...
        >
          <div
            className="absolute left-0 top-2 w-12 h-12 rounded-2xl flex items-center justify-center"
          ...
          <div className="glass-strong rounded-2xl p-6 hover:border-primary/40 transition-colors">
            ...
            <div className="flex flex-wrap gap-4 text-xs text-muted-foreground mt-4">
              <span className="inline-flex items-center gap-1.5">
                <Calendar size={12} /> Expected Graduation 2027
              </span>
              <span className="inline-flex items-center gap-1.5">
                <MapPin size={12} /> Purnea, Bihar
              </span>
            </div>
            <p className="text-sm text-muted-foreground leading-relaxed mt-4">
              Building a strong foundation in computer science fundamentals, web technologies, and
              software engineering principles — while shipping real-world projects on the side.
            </p>
          </div>
        </motion.div>
      </div>
