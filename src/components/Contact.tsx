...
const info = [
  { icon: Mail, label: "Email", value: "kumarisakshi7460@gmail.com", href: "mailto:kumarisakshi7460@gmail.com" },
...
export function Contact() {
  ...
  return (
    <Section id="contact">
      <SectionHeader kicker="Contact" title={<>Let's <span className="text-gradient">build something</span></>}
